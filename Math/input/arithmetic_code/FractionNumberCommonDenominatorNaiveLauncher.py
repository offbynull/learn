...
if __name__ == '__main__':
    log_whitelist([(inspect.getfile(FractionNumber), 'common_denominator_naive')])
    ...
    try:
        ...
        res = FractionNumber.common_denominator_naive(input1, input2)  # this will output markdown to stdout
    finally:
        print("</div>", end="\n\n")
