...
# MARKDOWN
def kmer_frequency_with_mismatches(data: str, k: int, min_hamming_dist: int) -> Counter[str]:
    counter = Counter()
...
def main():
    ...
    try:
        ...
        counts = kmer_frequency_with_mismatches(seq, k, min_hamming_dist)
        ...
        print(f'Top {k}-mer frequencies for {seq} with mismatches of {min_hamming_dist}:')
