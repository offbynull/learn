...
public final class DivideOperation implements BinaryOperation {
    
    private final Tree lefthand;
    private final Tree righthand;

    public DivideOperation(Tree lefthand, Tree righthand) {
    ...
    public BinaryOperation invert() {
        return new MultiplyOperation(righthand, lefthand);
    }
    ...
    public boolean equals(Object obj) {
        ...
        final DivideOperation other = (DivideOperation) obj;
